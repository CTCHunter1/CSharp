...
namespace Lab.Math.NelderMeadSimplex
{
    ...
    public sealed class NelderMeadSimplex
    {
        ...
        {
            double range = 2 * System.Math.Abs(errorValues[errorProfile.HighestIndex] - errorValues[errorProfile.LowestIndex]) /
                (System.Math.Abs(errorValues[errorProfile.HighestIndex]) + System.Math.Abs(errorValues[errorProfile.LowestIndex]) + JITTER);
