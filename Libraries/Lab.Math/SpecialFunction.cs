...
namespace Lab.Math
{
    ...
    public class SpecialFunction
    {
        ...
        public static double log10(double x)
        {
            ...
            return System.Math.Log(x) / 2.30258509299404568401;
        }
        ...
        public static double fac(double x)
        {
            ...
            if (System.Math.Floor(d) == d) return (double)fac((int)x);
        ...
        public static double erf(double x)
        {
            ...
            if (System.Math.Abs(x) > 1.0) return (1.0 - erfc(x));
            z = x * x;
