...
namespace Squid
{
    public class DataSeries
    {
        ...
        public enum Window { NONE, HAMMING };

        Window windowObj = Window.NONE;
        ...
        public DataSeries(int numPts, double sampleRate, AmpUnits fourierAmpUnits, double resistance)
        {
            ...
            {
                MessageBox.Show("Hamming Filter File Not Found\r\n" + ex.Message);
            }
        ...
        public static DataSeries[] CreateDataSeriesArray(int numDataSeries, int numPoints, double sampleRate, AmpUnits fourierAmpUnits, double resistance)
        {
            DataSeries[] dataSeriesArr = new DataSeries[numDataSeries];

            // initalize the array
            for (int i = 0; i < numDataSeries; i++)
            {
                dataSeriesArr[i] = new DataSeries(numPoints, sampleRate, fourierAmpUnits, resistance);
            }
